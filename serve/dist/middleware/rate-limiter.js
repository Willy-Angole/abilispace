...
exports.strictRateLimiter = void 0;
...
class RateLimitStore {
    ...
    cleanup() {
        ...
        logger_1.logger.debug('Rate limit store cleanup', {
            activeBuckets: this.buckets.size,
        });
    }
}
// Initialize rate limit store
const store = new RateLimitStore(environment_1.config.security.rateLimitMaxRequests, environment_1.config.security.rateLimitWindowMs);
/**
...
function rateLimiter(req, res, next) {
    ...
    res.setHeader('X-RateLimit-Limit', environment_1.config.security.rateLimitMaxRequests);
 ...
 */
exports.strictRateLimiter = createRateLimiter(5, 15 * 60 * 1000);
